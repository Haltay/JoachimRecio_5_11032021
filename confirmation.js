...
const confirmationDetails = `
        <div class="col-md-5 mt-5 confirmation-achat">
            ...
            <div class="d-flex justify-content-between"> <span class="font-weight-bold">Bientôt arrivera chez vous: <span class="nameTeddy"> </span> </span> <span class="text-muted">0 €</span> </div>
